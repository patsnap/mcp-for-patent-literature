...
metadata:
  ...
  version: 1.0.0
  requires:
    mcp_endpoint: "https://connect.patsnap.com/6415c2/logic-mcp?apikey=YOUR_API_KEY"
---
## Setup
...
```json
{
  "mcpServers": {
    "regulatory_guidelines": {
      "url": "https://connect.patsnap.com/6415c2/logic-mcp?apikey=YOUR_API_KEY",
      "type": "streamableHttp"
    }
  }
}
...
https://open.patsnap.com/marketplace/mcp-servers/regulatory-guidelines
...
### Label Safety Check
1. Search `fda_label_search` for a drug's boxed warnings and dosing.
2. Cross-check `clinical_guideline_search` for standard-of-care recommendations.
